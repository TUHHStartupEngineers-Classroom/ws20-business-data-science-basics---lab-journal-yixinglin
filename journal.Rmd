...
covid_population_by_countries <- covid_data_tbl %>% group_by(countriesAndTerritories) %>%
                summarise(popData2019 = max(popData2019)) 

covid_sum_by_countries = merge(x = covid_sum_by_countries, 
          y = covid_population_by_countries, 
          by = "countriesAndTerritories", all.x = T)
...
covid_sum_by_countries %>% ggplot(aes(map_id = countriesAndTerritories)) +
      ...
      scale_fill_gradient(low='red', high='#202020', 
                          name = "Mortality Rate", 
